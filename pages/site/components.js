...
function SitePageComponents() {
            ...
            <div key={style} className="col-lg-4">
                ...
                <div className="form-group">
                    ...
                    <button type="button" className={`btn btn-${style} btn-xl btn-svg-icon`}>
                        <Image src='/icons/quickview-16.svg' height={16} width={16} />
                    </button>
                </div>
                <div className="form-group">
    ...
    return (
        <>
            <Head>
                <title>{`Komponentler — ${theme.name}`}</title>
            </Head>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="alert alert-primary alert-lg mb-3 alert-dismissible fade show">
                                ...
                                {' '}
                                <Link href="/"><a>an example link</a></Link>
                                . Give it a click if you like.

                                <button type="button" className="close" data-dismiss="alert" aria-label="Close">
                                    <Image src='/icons/cross-12.svg' height={12} width={12} />
                                </button>
                            </div>
                        </div>
