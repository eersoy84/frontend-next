...
class BlockProductsCarousel extends Component {
    handleNextClick = () => {
      if (this.slickRef) {
    ...
    render() {
      ...
      const columns = this.productsColumns().map((column, index) => {
        const products = column.map((product) => (
          <div key={product.adId} className="block-products-carousel__cell">
...
// };
export default BlockProductsCarousel;// connect(mapStateToProps, null)(BlockProductsCarousel);
