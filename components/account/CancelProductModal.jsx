...
export default function CancelProductModal(props) {
    const { userCartItem, show, onHide, hideCancelProductButton, reasons } = props;
    ...
    const sendEvaluation = () => {
        ...
        axios.post(`${API_BASE}/orders/cancelProduct`,
            ...
            .then((data) => {
                if (data) {
                    toast.info("Ürün iptal talebiniz başarıyla alındı")
                    setIsLoading(false);
                    resetToInitialValues();
                    hideCancelProductButton();
                }
            }).catch((err) => {
                toast.error("Ürün iptal talebi oluşturulurken hata oluştu!")
                setIsLoading(false)
            });
    }
        ...
        <Modal isOpen={show} centered unmountOnClose>
            <form onSubmit={handleSubmit}>
                <div className="modal-header">
                    <h5 className="modal-title">Ürün İptal</h5>
                    <button
                        type="button"
                        className="close"
                        data-dismiss="modal"
                    ...
                    <div className="row">
                        <div className="col-12">
                            <div className="form-group">
                                <label hstyle={{ fontSize: '15px', fontWeight: 'bolder' }}>Neden İptal etmek istiyorsunuz</label>
                                <Select options={options}
                                    placeholder="İptal sebebinizi giriniz..."
