export default [
...

    {
        ...
        children: [
            ...
            { type: 'link', label: 'Shop List', url: '/kategori' },
            ...
            { type: 'link', label: 'Cart', url: '/sepet' },
            { type: 'link', label: 'Delivery', url: '/checkout' },
            { type: 'link', label: 'Order Success', url: '/checkout/success' },
            { type: 'link', label: 'Wishlist', url: '/favoriler' },
...

    {
        ...
        children: [
            ...
            { type: 'link', label: 'Edit Address', url: '/hesap/adres/edit' },
            { type: 'link', label: 'Change Password', url: '/hesap/sifre-yenile' },
        ],
    },
...

    {
        ...
        url: '/site/hakkimizda',
        children: [
            { type: 'link', label: 'About Us', url: '/site/hakkimizda' },
            { type: 'link', label: 'Contact Us', url: '/site/iletisim' },
            { type: 'link', label: 'Contact Us Alt', url: '/site/iletisim-alt' },
            { type: 'link', label: '404', url: '/site/not-found' },
            { type: 'link', label: 'Terms And Conditions', url: '/site/kosullar' },
            { type: 'link', label: 'FAQ', url: '/site/sss' },
